...
**Source:** `contracts/DealEscrow.sol` · **Atlantic v1.2.0** — see [upgrade-strategy.md](upgrade-strategy.md)
...
|----------|------------------|-------------|
| `createDeal(..., arbiter)` | → Created | `"zero address"`, `"zero amount"`, `"zero ttl"`, `"zero dispute window"` |
